...
class Public extends Component {
    ...
    handleDelete = () => {
        return this.setState({
            ...
            return window.location.href = "/public";//window.reload
        });
    };
    ...
    render() {
        ...
        return (
            <React.Fragment key={id}>
                <div key={id}>
                    <h2 className="title">
                        <Link to={`/@jhondoe/${id}`}>{story.title}</Link>
                    </h2>
                    {story.subtitle.length !== 0 ? (
                        <div className="subtitle">
                            <Link to={`/@jhondoe/${id}`}>{story.subtitle}</Link>
                        </div>
                    ):null}
                        ...
                        <div className="arrow-down" ref={this.handleRef} onClick={this.handleShowDropDown}>
                            ...
                            {this.state.dropDown ? (
                                <div className="drop-down">
                                    <div className="edit">
                                        <Link to={`/p/${id}/edit`}>Edit story</Link>
                                    </div>
                                    <div className="delete" onClick={this.handleShowDeleteModal}>Delete story</div>
                                    <div className="story-settings">
                                        <Link to={`/p/${id}/settings`}>Story settings</Link>
                                    </div>
                                </div>
                            ):null}
                        </div>
